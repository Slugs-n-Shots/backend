...
#[OA\Patch(path: '/staff/categories/{category}', operationId: 'staffPatchCategory', summary: 'Partially update a drink category', tags: ['Staff categories'], security: [['bearerAuth' => []]], parameters: [
...
final class StaffPatchCategorySwagger
{
}
