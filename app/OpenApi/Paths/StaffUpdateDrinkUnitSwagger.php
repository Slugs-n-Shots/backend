...
#[OA\Put(path: '/staff/drink-units/{drink_unit}', operationId: 'staffUpdateDrinkUnit', summary: 'Update a drink unit', tags: ['Staff drink units'], security: [['bearerAuth' => []]], parameters: [
...
final class StaffUpdateDrinkUnitSwagger
{
}
