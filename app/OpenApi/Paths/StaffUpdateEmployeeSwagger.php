...
#[OA\Put(path: '/staff/employees/{employee}', operationId: 'staffUpdateEmployee', summary: 'Update an employee', tags: ['Staff employees'], security: [['bearerAuth' => []]], parameters: [
...
final class StaffUpdateEmployeeSwagger
{
}
