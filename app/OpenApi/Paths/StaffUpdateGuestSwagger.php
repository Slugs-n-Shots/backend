...
#[OA\Put(path: '/staff/guests/{guest}', operationId: 'staffUpdateGuest', summary: 'Update a guest', tags: ['Staff guests'], security: [['bearerAuth' => []]], parameters: [
...
final class StaffUpdateGuestSwagger
{
}
